    ...
    <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            {ingredients.map(({ id, name, icon }) => (
              <motion.button
                ...
                className={`
                  min-touch-target min-touch-target px-6 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all touch-manipulation
      ...
      <div className="flex gap-4 justify-between pt-12">
        <button
          ...
          className="min-touch-target px-8 py-3 text-text-dark dark:text-text-primary border-2 border-text-dark dark:border-border-subtle rounded-2xl font-bold hover:bg-text-dark dark:hover:bg-surface-muted hover:text-white dark:hover:text-text-primary transition-all flex-1 md:flex-none flex items-center justify-center touch-manipulation"
        >
