  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-cream-bg dark:bg-background pb-20" dir="rtl">
        {/* Hardcoded dark test: red in light, blue in dark – remove after verifying toggle */}
        <div className="bg-red-500 dark:bg-blue-500 h-12 w-12 rounded-lg fixed bottom-24 left-4 z-50 ring-2 ring-white shadow-lg" title="Dark test: red→light, blue→dark" />
        {/* Header Section */}
